...
def analyze_tree_health(image_paths_list):
     ...
     try:
          ...
          prompt = (
               ...
               "\n\n"
               "BOXING RULES:"
               "- If the plant is HEALTHY: The box must cover the ENTIRE TREE/PLANT."
               "- If the plant is DISEASED/STRESSED: The box must cover ONLY the specific affected/diseased area."
               "\n\n"
